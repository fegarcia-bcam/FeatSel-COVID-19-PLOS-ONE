...
# balancing
BALANCER = 'rand-oversample'
BALANCER_PARAMS = {'sampling_strategy': 'not majority', 'shrinkage': 0.01}

# feature selection
FEATURE_SELECTOR = 'embed'

# feature selection parameters
FEAT_SELECTORS = [{'analysis': 'classif', 'selector_params': {'estimator': 0.075, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'classif', 'selector_params': {'estimator': 0.050, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'classif', 'selector_params': {'estimator': 0.025, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'regress', 'selector_params': {'estimator': 0.005, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'regress', 'selector_params': {'estimator': 0.010, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'regress', 'selector_params': {'estimator': 0.025, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'classif', 'selector_params': {'estimator': 0.010, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'classif', 'selector_params': {'estimator': 0.005, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'regress', 'selector_params': {'estimator': 0.050, 'prefit': False, 'threshold': None, 'max_features': None}},
                  {'analysis': 'regress', 'selector_params': {'estimator': 0.075, 'prefit': False, 'threshold': None, 'max_features': None}}]
    ...
    for sel in FEAT_SELECTORS:
        ...
        if analysis == 'classif':
            for imp in IMPUTERS:
                ...
                f_results = os.path.join(config.PATH_RESULTS_EMB, filename)
