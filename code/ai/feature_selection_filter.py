...
FEAT_SELECTORS = [{'analysis': 'classif',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_classif', 'mode': 'k_best', 'param': 5}},
                  {'analysis': 'classif',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_classif', 'mode': 'k_best', 'param': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_classif', 'mode': 'k_best', 'param': 20}},
                  {'analysis': 'classif',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_classif', 'mode': ' k_best', 'param': 40}},
                  {'analysis': 'regress',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_regression', 'mode': 'k_best', 'param': 5}},
                  {'analysis': 'regress',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_regression', 'mode': 'k_best', 'param': 10}},
                  {'analysis': 'regress',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_regression', 'mode': 'k_best', 'param': 20}},
                  {'analysis': 'regress',
                   'feature_selector': 'filter-univar',
                   'selector_params': {'score_func': 'mutual_info_regression', 'mode': 'k_best', 'param': 40}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MIQ', 'nfeats': 5}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MIQ', 'nfeats': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MIQ', 'nfeats': 20}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MIQ', 'nfeats': 40}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MID', 'nfeats': 5}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MID', 'nfeats': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MID', 'nfeats': 20}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-mrmr',
                   'selector_params': {'method': 'MID', 'nfeats': 40}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-fcbf',
                   'selector_params': {'delta': 0.0}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 5, 'discrete_threshold': 2, 'n_neighbors': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 10, 'discrete_threshold': 2, 'n_neighbors': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 20, 'discrete_threshold': 2, 'n_neighbors': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 40, 'discrete_threshold': 2, 'n_neighbors': 10}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 5, 'discrete_threshold': 2, 'n_neighbors': 100}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 10, 'discrete_threshold': 2, 'n_neighbors': 100}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 20, 'discrete_threshold': 2, 'n_neighbors': 100}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-relieff',
                   'selector_params': {'n_features_to_select': 40, 'discrete_threshold': 2, 'n_neighbors': 100}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-multisurf',
                   'selector_params': {'n_features_to_select': 5, 'discrete_threshold': 2}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-multisurf',
                   'selector_params': {'n_features_to_select': 10, 'discrete_threshold': 2}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-multisurf',
                   'selector_params': {'n_features_to_select': 20, 'discrete_threshold': 2}},
                  {'analysis': 'classif',
                   'feature_selector': 'filt-multisurf',
                   'selector_params': {'n_features_to_select': 40, 'discrete_threshold': 2}}]
...
if __name__ == '__main__':
    ...
    for sel in FEAT_SELECTORS:
        ...
        feature_selector = sel['feature_selector']
        ...
        if analysis == 'classif':
            for imp in IMPUTERS:
                ...
                f_results = os.path.join(config.PATH_RESULTS_FIL, filename)
