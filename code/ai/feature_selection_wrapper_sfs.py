...
# feature selection
FEATURE_SELECTOR = 'wrap-sfs'

# feature selection parameters
DIRECTION = 'forward'

FEAT_SELECTORS_MAIN = [{'analysis': 'classif',
                        'selector_params': {'estimator': 'KNNC', 'n_features_to_select': 5,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'KNNC', 'n_features_to_select': 10,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'KNNC', 'n_features_to_select': 20,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'KNNC', 'n_features_to_select': 40,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'KNNR', 'n_features_to_select': 5,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'KNNR', 'n_features_to_select': 10,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'KNNR', 'n_features_to_select': 20,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'KNNR', 'n_features_to_select': 40,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'LogReg', 'n_features_to_select': 5,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'LogReg', 'n_features_to_select': 10,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'LogReg', 'n_features_to_select': 20,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'classif',
                        'selector_params': {'estimator': 'LogReg', 'n_features_to_select': 40,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'Ridge', 'n_features_to_select': 5,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'Ridge', 'n_features_to_select': 10,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'Ridge', 'n_features_to_select': 20,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                       {'analysis': 'regress',
                        'selector_params': {'estimator': 'Ridge', 'n_features_to_select': 40,
                                            'direction': DIRECTION, 'cv': config.N_CV_SPLITS}}]

FEAT_SELECTORS_HGB = [{'analysis': 'classif',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBC', 'n_features_to_select': 5,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'classif',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBC', 'n_features_to_select': 10,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'classif',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBC', 'n_features_to_select': 20,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'classif',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBC', 'n_features_to_select': 40,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'regress',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBR', 'n_features_to_select': 5,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'regress',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBR', 'n_features_to_select': 10,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'regress',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBR', 'n_features_to_select': 20,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}},
                      {'analysis': 'regress',
                       'imputer': 'none', 'imputer_params': {},
                       'selector_params': {'estimator': 'HGBR', 'n_features_to_select': 40,
                                           'direction': DIRECTION, 'cv': config.N_CV_SPLITS}}]
    ...
    for sel in FEAT_SELECTORS_MAIN:
        ...
        if analysis == 'classif':
            for imp in IMPUTERS:
                ...
                f_results = os.path.join(config.PATH_RESULTS_WRA_SFS, filename)
